...
DATA = {
    "أطباء": [
        ...
        # --- قسم الجملة العصبية (2 أطباء) ---
        {"n": "د. عمر الخفاجي", "s": "جملة عصبية", "desc": "جراح دماغ وفقرات", "a": "الجادرية", "lat": 33.2801, "lon": 44.3905, "stars": 5, "p": "07705556667"},
        {"n": "د. ليث الدوري", "s": "جملة عصبية", "desc": "أخصائي أعصاب وجلطات", "a": "المنصور", "lat": 33.3251, "lon": 44.3482, "stars": 4, "p": "07700001112"},
        
        # --- قسم الباطنية (3 أطباء) ---
        {"n": "د. حسن الهاشمي", "s": "باطنية", "desc": "أخصائي هضمية وكبد", "a": "الأعظمية", "lat": 33.3652, "lon": 44.3751, "stars": 5, "p": "07801212123"},
        {"n": "د. ميسون الورد", "s": "باطنية", "desc": "استشارية غدد وسكري", "a": "زيونة", "lat": 33.3401, "lon": 44.4502, "stars": 5, "p": "07905554443"},
        {"n": "د. خالد العبيدي", "s": "باطنية", "desc": "أخصائي أمراض كلى", "a": "الكرادة", "lat": 33.3135, "lon": 44.4291, "stars": 4, "p": "07809998887"},
        
        # --- قسم المفاصل (2 أطباء) ---
        {"n": "د. مريم القيسي", "s": "مفاصل", "desc": "أخصائية الروماتزم", "a": "الكرادة", "lat": 33.3135, "lon": 44.4291, "stars": 5, "p": "07901231234"},
        {"n": "د. أحمد الفارس", "s": "مفاصل", "desc": "جراحة العظام والمفاصل", "a": "الحارثية", "lat": 33.3222, "lon": 44.3585, "stars": 4, "p": "07806667778"}
    ],
    "أعراض": {
