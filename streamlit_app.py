...
# --- 1. محرك الذكاء الاصطناعي المحدث ---
    ...
    try:
        if "GEMINI_API_KEY" in st.secrets:
            ...
            if available_models:
                ...
                4. حدد الاختصاص المطلوب بكلمة واحدة فقط من بين (قلبية، باطنية، مفاصل، عيون، جلدية، أسنان، نفسية).
                الحالة: {prompt_text}
                """
...
st.markdown(r'''
    ...
    * { font-family: 'Tajawal', sans-serif; direction: rtl; text-align: right; }
    ...
    .wish-text { text-align: center; color: #40E0D0; font-size: 18px; margin-top: 15px; font-weight: bold; }
    </style>
...
DATA = {
    "أطباء": [
        # قلبية
        {"n": "د. علي الركابي", "s": "قلبية", "a": "الحارثية", "stars": "⭐⭐⭐⭐⭐", "dist": 1.2, "phone": "07701234567", "rank": "الأكثر خبرة", "slots": [("03:00 PM", True), ("04:30 PM", False), ("06:00 PM", True)]},
        {"n": "د. أحمد الموسوي", "s": "قلبية", "a": "المنصور", "stars": "⭐⭐⭐⭐", "dist": 2.1, "phone": "07712223334", "rank": "استشاري قسطرة", "slots": [("03:30 PM", True), ("05:00 PM", True), ("06:30 PM", True)]},
        # باطنية
        {"n": "د. سارة الجبوري", "s": "باطنية", "a": "المنصور", "stars": "⭐⭐⭐⭐", "dist": 3.5, "phone": "07801112223", "rank": "بورد عربي", "slots": [("03:30 PM", True), ("05:00 PM", True), ("06:30 PM", False)]},
        {"n": "د. ليث حسين", "s": "باطنية", "a": "زيونة", "stars": "⭐⭐⭐⭐⭐", "dist": 4.2, "phone": "07810009998", "rank": "خبير هضمية", "slots": [("03:00 PM", False), ("04:30 PM", True), ("06:00 PM", True)]},
        # مفاصل
        {"n": "د. مريم القيسي", "s": "مفاصل", "a": "الكرادة", "stars": "⭐⭐⭐⭐⭐", "dist": 5.0, "phone": "07901231234", "rank": "استشاري", "slots": [("04:00 PM", False), ("05:30 PM", True), ("07:00 PM", True)]},
        # عيون
        {"n": "د. ياسمين الخفاجي", "s": "عيون", "a": "شارع فلسطين", "stars": "⭐⭐⭐⭐⭐", "dist": 2.8, "phone": "07730001112", "rank": "جراحة ليزر", "slots": [("04:00 PM", True), ("05:30 PM", True), ("07:00 PM", False)]},
        # جلدية
        {"n": "د. رؤى العبيدي", "s": "جلدية", "a": "حي الجامعة", "stars": "⭐⭐⭐⭐⭐", "dist": 1.5, "phone": "07504445556", "rank": "تجميل وليزر", "slots": [("04:30 PM", True), ("06:00 PM", False), ("07:30 PM", True)]},
        # أسنان
        {"n": "د. مصطفى الوائلي", "s": "أسنان", "a": "زيونة", "stars": "⭐⭐⭐⭐⭐", "dist": 4.0, "phone": "07748889990", "rank": "زراعة أسنان", "slots": [("03:30 PM", True), ("05:00 PM", False), ("06:30 PM", True)]},
        # نفسية
        {"n": "د. سامر الملا", "s": "نفسية", "a": "المنصور", "stars": "⭐⭐⭐⭐⭐", "dist": 2.4, "phone": "07705556667", "rank": "استشاري طب نفسي", "slots": [("03:00 PM", True), ("04:30 PM", True), ("06:00 PM", False)]}
    ]
}
...
# --- المرحلة 3: تأكيد الحجز ---
    ...
    st.markdown(f'''
        ...
        <div class="wish-text">مع تمنياتنا لك بالشفاء العاجل ✨</div>
    ''', unsafe_allow_html=True)
