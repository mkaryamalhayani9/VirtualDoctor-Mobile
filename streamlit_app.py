    ...
    try:
        if "GEMINI_API_KEY" in st.secrets:
            ...
            if available_models:
                ...
                4. حدد الاختصاص المطلوب بكلمة واحدة فقط من بين (قلبية، باطنية، مفاصل، عيون، جلدية، أسنان، نفسية، أعصاب).
                الحالة: {prompt_text}
                """
...
DATA = {
    "أطباء": [
        ...
        # أعصاب ودماغ
        {"n": "د. كمال الربيعي", "s": "أعصاب", "a": "الحارثية", "stars": "⭐⭐⭐⭐⭐", "dist": 1.1, "phone": "07800001111", "rank": "استشاري جملة عصبية", "slots": [("04:00 PM", True), ("05:30 PM", True), ("07:00 PM", True)]},
        {"n": "د. هدى التميمي", "s": "أعصاب", "a": "الكرادة", "stars": "⭐⭐⭐⭐", "dist": 3.2, "phone": "07802223333", "rank": "بورد اختصاص", "slots": [("03:30 PM", True), ("05:00 PM", False), ("06:30 PM", True)]}
    ]
}
